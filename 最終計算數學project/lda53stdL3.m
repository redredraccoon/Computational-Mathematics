...
nf=10;     n=48;                       % nf features, n patterns
L(1)=16;  L(2)=32;  L(3)=48;          % L(3)=n
...
figure;
plot(X1,Y1,'d',X2,Y2,'O',X3,Y3,'X');
grid;
legend('- 1','- 2','- 3')
% axis([2 24 -2 20]); grid;
title('First Two Linear Discriminant Projection for data53stdL3')
...
figure;
plot3(X1,Y1,Z1,'d',X2,Y2,Z2,'O',X3,Y3,Z3,'X','markersize',10);
grid;
legend('- 1','- 2','- 3')
%axis([2 24 -2 20]); grid;
title('First Three Linear Discriminant Projection for 53stdL3 Data')